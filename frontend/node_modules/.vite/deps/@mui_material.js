...
var Tab = React110.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime130.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime130.jsxs)(React110.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime130.jsxs)(React110.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
